        ...
        <>
            ...
            <section className='relative h-auto w-full z-10 bg-[#f3f1ec] border-[#f3f1ec] border-8 rounded-3xl my-10 shadow-lg py-8'>
                <div className='grid gap-4 md:flex md:p-16 p-8 text-zinc-800'>
                    ...
                    <p className='md:w-1/2 text-sm md:text-base'>The platform connects farmers with buyers via smart contracts, enabling secure, transparent agreements. Smart contracts automatically enforce the terms, ensuring that both farmers and buyers meet their obligations. Using blockchain technology, we ensure security, trust, and transparency in every transaction.</p>
                </div>
