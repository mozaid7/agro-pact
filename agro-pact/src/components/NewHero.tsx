    ...
    return (
        <div className="z-0">
            ...
            >
                <div className="flex items-center justify-center pt-24 gap-2 z-10">
                    ...
                    <div className="w-32 items-center">
                        <Image src="./grain_img.svg" className="h-[55vh] w-fit object-cover" width={24} height={24} alt="fdsf" priority />
                    </div>
            ...
            <div className="items-center flex flex-col justify-center pt-16">
                <h1 className="text-2xl md:text-3xl lg:text-6xl font-bold text-gray-800 text-center py-2">Your Trusted Partner in Agriculture</h1>
                <h2 className="text-zinc-500 text-xl text-center">Connecting Farmers & Buyers with Transparent & Secure Farming Contracts.</h2>
