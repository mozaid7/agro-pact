...
const Hero = () => {
  ...
  return <>
    ...
    <section className="bg-[#0c5934] border-8 border-[#5ee4a396] min-h-full min-w-full mt-6 px-20 pt-20 text-white rounded-3xl">
      ...
      <h1 className="text-8xl font-light tracking-tighter font-sans pb-12">Every grain holds value & purpose, ensuring none go to waste & turning that purpose into profit.</h1>
